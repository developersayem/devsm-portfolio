  ...
  return (
    <div className="card card-compact bg-base-100 shadow-xl">
      <div className="card-body">
        <h1 className="text-2xl font-bold py-3">My Expert Area</h1>
        <div className="grid grid-cols-3 gap-2 gap-y-5 my-5">
          <div>
            <div className="bg-[#F0F2F5] rounded-lg p-3 flex justify-center items-center transition-transform ease-in-out duration-300 hover:scale-75">
